...
本章将要介绍用来表示内容的不同部分的元素，说明如何划分内容以便将各个主题和概念分隔开来。这些元素大都是新增的，它们构成了语义和呈现分离实践的重要基础。然而这也意味着这些元素有点难以演示，因为它们在外观上对内容的影响微乎其微，甚至根本没有影响。为此本章在许多例子中为这些元素应用了一些 CSS 样式，以强调其结构和带来的变化。
