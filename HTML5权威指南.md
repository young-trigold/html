...
- [12. 理解 CSS](#12-理解-css)
  ...
  - [12.3. 选择器概览](#123-选择器概览)
    ...
    - [12.3.5. 并集选择器](#1235-并集选择器)
  - [12.4. 属性概览](#124-属性概览)
    - [12.4.1. 文本属性](#1241-文本属性)
...
- [14. 文本](#14-文本)
  ...
  - [14.6. 首行缩进](#146-首行缩进)
  - [14.7. 文本装饰](#147-文本装饰)
  - [14.8. 大小写转换](#148-大小写转换)
  - [14.9. 文本阴影](#149-文本阴影)
  - [14.10. 自定义字体](#1410-自定义字体)
- [15. 盒模型](#15-盒模型)
  - [15.1. 内容](#151-内容)
  - [15.2. 背景](#152-背景)
  - [15.3. 内边距](#153-内边距)
  ...
  - [15.7. 盒子整体](#157-盒子整体)
- [16. 布局](#16-布局)
  - [16.1. 浮动和定位](#161-浮动和定位)
  - [16.2. 多列布局](#162-多列布局)
  - [16.3. 弹性盒子](#163-弹性盒子)
  - [16.4. 网格布局](#164-网格布局)
- [17. 过渡，动画和渐变](#17-过渡动画和渐变)
...
| 相邻兄弟选择器 | <基本选择器 A> + <基本选择器 B> | p + span  | A 选定元素之后紧跟的同级 B 元素 | 2        |
...
| :in-range            | <选择器>:in-range             | input:in-range         | 选取在 min 和 max 范围之内的元素      | 3        |
| :out-of-range        | <选择器>:out-of-range         | input:out-of-range     | 选取不在 min 和 max 范围之内的元素    | 3        |
...
| 选择器     | 语法                        | 例子       | 说明                     | CSS 版本 |
| ---------- | --------------------------- | ---------- | ------------------------ | -------- |
| 并集选择器 | <选择器 1>, <选择器 2>, ... | h1, h2, h3 | 每个选择器选中元素的并集 | 1        |
