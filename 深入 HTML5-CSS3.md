...
- [2. HTML5 背景](#2-html5-背景)
  - [2.1. HTML 的历史](#21-html-的历史)
    - [2.1.1. JavaScript 的出场](#211-javascript-的出场)
    - [2.1.2. 浏览器战争的结束](#212-浏览器战争的结束)
    - [2.1.3. 插件称雄](#213-插件称雄)
    - [2.1.4. 语义 HTML](#214-语义-html)
    - [2.1.5. HTML 标准滞后于使用](#215-html-标准滞后于使用)
  - [2.2. HTML5 简介](#22-html5-简介)
    - [2.2.1. 新标准](#221-新标准)
    - [2.2.2. 引入原生多媒体](#222-引入原生多媒体)
    - [2.2.3. 引入可编程内容](#223-引入可编程内容)
    - [2.2.4. 引入语义 Web](#224-引入语义-web)
- [3. HTML 基础](#3-html-基础)
  - [3.1. 元素](#31-元素)
    - [3.1.1. 虚元素](#311-虚元素)
  - [3.2. 元素属性](#32-元素属性)
    ...
    - [3.2.2. 元素类型](#322-元素类型)
    - [3.2.3. 布尔属性](#323-布尔属性)
    - [3.2.4. 自定义属性](#324-自定义属性)
  - [3.3. HTML 文档](#33-html-文档)
    - [3.3.1. 外层结构](#331-外层结构)
    - [3.3.2. head](#332-head)
    - [3.3.3. body](#333-body)
  - [3.4. HTML 实体](#34-html-实体)
  - [3.5. 全局属性](#35-全局属性)
    - [3.5.1. 选择器属性](#351-选择器属性)
    - [3.5.2. 键盘快捷键属性](#352-键盘快捷键属性)
    - [3.5.3. contentEditable](#353-contenteditable)
    - [3.5.4. hidden](#354-hidden)
    - [3.5.5. lang](#355-lang)
    - [3.5.6. title](#356-title)
    - [3.5.7. draggable](#357-draggable)
    - [3.5.8. style](#358-style)
...
- [12. CSS 基础](#12-css-基础)
  - [12.1. 定义和应用样式](#121-定义和应用样式)
    - [12.1.1. CSS 声明](#1211-css-声明)
    - [12.1.2. 行内样式](#1212-行内样式)
    - [12.1.3. 内部样式表](#1213-内部样式表)
    - [12.1.4. 外部样式表](#1214-外部样式表)
  - [12.2. 层叠和继承](#122-层叠和继承)
    - [12.2.1. 用户代理样式](#1221-用户代理样式)
    - [12.2.2. 样式的层叠](#1222-样式的层叠)
    - [12.2.3. !important](#1223-important)
    - [12.2.4. 样式冲突](#1224-样式冲突)
    - [12.2.5. 继承](#1225-继承)
  - [12.3. 颜色](#123-颜色)
  - [12.4. 长度](#124-长度)
    - [12.4.1. 绝对单位](#1241-绝对单位)
    - [12.4.2. 相对单位](#1242-相对单位)
  - [12.5. 其他单位](#125-其他单位)
    - [12.5.1. 角度](#1251-角度)
    - [12.5.2. 时间](#1252-时间)
- [13. 理解 CSS](#13-理解-css)
  - [13.1. CSS 标准化](#131-css-标准化)
  - [13.2. 盒模型](#132-盒模型)
  - [13.3. 选择器概览](#133-选择器概览)
    - [13.3.1. 基本选择器](#1331-基本选择器)
    - [13.3.2. 组合选择器](#1332-组合选择器)
    - [13.3.3. 伪元素选择器](#1333-伪元素选择器)
    - [13.3.4. 伪类选择器](#1334-伪类选择器)
    - [13.3.5. 分组选择器](#1335-分组选择器)
  - [13.4. 属性概览](#134-属性概览)
    - [13.4.1. 盒模型属性](#1341-盒模型属性)
    - [13.4.2. 布局属性](#1342-布局属性)
    - [13.4.3. 文本属性](#1343-文本属性)
    - [13.4.4. 过渡，动画和变换属性](#1344-过渡动画和变换属性)
    - [13.4.5. 其他属性](#1345-其他属性)
- [14. CSS 选择器](#14-css-选择器)
  - [14.1. 基本选择器](#141-基本选择器)
    - [14.1.1. 通用选择器](#1411-通用选择器)
    - [14.1.2. 元素选择器](#1412-元素选择器)
    - [14.1.3. 类选择器](#1413-类选择器)
    - [14.1.4. id 选择器](#1414-id-选择器)
    - [14.1.5. 属性选择器](#1415-属性选择器)
  - [14.2. 组合选择器](#142-组合选择器)
    - [](#)
  - [14.3. 伪元素选择器](#143-伪元素选择器)
  - [14.4. 伪类选择器](#144-伪类选择器)
  - [14.5. 分组选择器](#145-分组选择器)
